...
DATA_ROOT = (
    REPO_ROOT / "00temp" / "orographic_temperature_downscaling" / "test_data"
)
APPLY_DATA_DIR = DATA_ROOT / "apply_lapse_rate_data"
LAPSE_DATA_DIR = DATA_ROOT / "temp_lapse_rate_data"
