...
_data_transfer = import_module(
    "NIMM.04single_calibration.kalman_element_forecast_correction.data_transfer"
)
DEFAULT_TRANSFER_CONFIG = _data_transfer.DEFAULT_TRANSFER_CONFIG
TransferConfig = _data_transfer.TransferConfig
copy_process_data = _data_transfer.copy_process_data
