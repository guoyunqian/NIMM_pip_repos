...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 诊断相关 | **feels_like_temperature** | 根据气温、10 米风速、相对湿度和气压综合风寒与显温，计算体感温度诊断场 | 2026-08-17 | 郭云谦、王亭波 | 见下表「feels_like_temperature 目录明细」 | `python -m feels_like_temperature.cli.der_feel_like_temp` | 见下表「feels_like_temperature 待办」 |
...
| CLI | `cli/der_feel_like_temp.py`、`cli/preprocess_test_data.py` | 体感温度示例调度与官方样例预处理 |
| 文档 | `docs/feels_like_temperature.md` | 算法说明 |
| notebook | `nbs/feels_like_temperature.ipynb` | 示例与验证 |
| 测试 | `test/test_feels_like_temperature.py`、`test/test_official_feels_like_temperature.py` 等 | 单元测试与官方样例 |
| 整理日志 | `00log/feels_like_temperature_整理_20260817.log` | 本次整理过程记录 |
...
| 4 | test_data | 中间目录未同步官方样例；缺数据时官方对照测试会 skip |
