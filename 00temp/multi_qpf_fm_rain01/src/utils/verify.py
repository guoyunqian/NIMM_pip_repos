...
para_example= {
    ...
    "station_file":r"D:/Work/multi_qpf_fm_rain01/resource/data/R01_national/sfc/20251001/h01_202510010000.m3",
    # "station_file":"",
    "defalut_value":0,
    "hdf_file_name":"verify_data.h5",
    "interp": meteva.base.interp_gs_nearest,
    "ob_data":{
        "dir_ob": r"D:/Work/multi_qpf_fm_rain01/resource/data/R01_national/sfc/YYYYMMDD/h01_YYYYMMDDHH00.m3",
        "hour": [0, 23, 1],
    ...
    "fo_data":{
        ...
        "multi_qpf_fm_rain01": {
            "dir_fo": r"D:/Work/multi_qpf_fm_rain01/resource/data/output/rain01/ecmwf_nimm/YYYYMMDD/YYYYMMDDHH.TTT.m3",
            "hour": [0, 12, 12],
            "dtime": [1, 48, 1],
            "read_method": meteva.base.io.read_stadata_from_micaps3,
            "read_para": {},
...
if __name__ == "__main__":
    h5_file = "D:/Work/multi_qpf_fm_rain01/resource/data/output/verify_data.h5"
