...
para_example= {
    ...
    "fo_data":{
        ...
        "fengqing": {
            "dir_fo": r"/mnt/nimm_data/model_RT/FENGQING/APCP24/YYYY/YYYYMMDD/YYYYMMDDHH.TTT.nc",
            "hour": [0, 12, 12],
            "dtime": [36, 252, 24],
            "read_method": meteva.base.io.read_griddata_from_nc,
            "read_para": {},
...
if __name__ == "__main__":
    ...
    # print(sta_all)
    # h5_file = "sta_all.h5"
    # sta_all.to_hdf("sta_all.h5", key="sta_all")
    ...
    # 处理检验，生成图片，保存检验结果
    # sta_all = pd.read_hdf(r"D:\Work\mait_24h\resource\verify_data.h5", key="df")
    h5_file = r"D:\Work\mait_24h\resource\verify_data.h5"
    ...
    #
    product_list = ["ec_dz", "ec", "aifs_dz", "aifs", "fengqing_dz", "fengqing", 'mait', 'mait_ai']
    grade_list = [0.1, 10, 25, 50, 100]
