            ...
            for dt in dtimes:
                ...
                if dir_fo is None:
                    ...
                    if file_exit:
                        # if os.path.exists(path) or path is None:
                        try:
                            print("=---------------------------->>>fo path: ", file_time_moved, path)
...
def creat_ob_dataset_on_foTime(para,ele = "ob",times = None,recover = True):
    ...
    if times is None:
        times = []
        time1 = begin_time
        while time1 <= end_time + datetime.timedelta(hours=24):
            times.append(time1)
            time1 = time1 + datetime.timedelta(hours = 1)
...
if __name__ == "__main__":
    para_conf = {
        ...
        "end_time": datetime.datetime(2025, 8, 6, 0, 0, 0),
        "station_file": r"/data/python_code/mait_24h_20260117/info/station_info.txt",
        "defalut_value": 0,
        ...
        "output_dir": r"/data/python_code/mait_24h_20260117/plugin/h5"
    }
    prepare_dataset(para_conf)
