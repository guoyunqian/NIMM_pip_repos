...
def task(ftime):
    ...
    for dtime in dtimes:
        ...
        if os.path.exists(mt_path) and os.path.exists(cma3km_path) and os.path.exists(ob_path):
            ...
            cma3km_grd = cma3km_grd - bef_cma3km_grd
            ...
            # axs = meb.creat_axs(3, map_extend, ncol=3, add_index=["观测", "CMA_3KM", "MAIT"], sup_title=f"{ftime}_{dtime:03d}时效降水", sup_fontsize=26, wspace=1, height=26, width=26)
...
if __name__ == '__main__':
    dates = [
        ...
        "20250801", "20250802", "20250803", "20250817", "20250818", "20250821", "20250822",
        "20250823", "20250825",
    ]
    # main(dates)
    task("2025070100")
