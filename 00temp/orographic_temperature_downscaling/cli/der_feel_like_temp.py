...
if __name__ == "__main__":
    ...
    #各输入文件的路径映射
    temperature_path = str(data_dir / "20181121T1200Z-PT0012H00M-temperature_at_screen_level.nc")   #温度场nc文件路径
    wind_speed_path = str(data_dir / "20181121T1200Z-PT0012H00M-wind_speed_at_10m.nc")   #风速场nc文件路径
    relative_humidity_path = str(
        data_dir / "20181121T1200Z-PT0012H00M-relative_humidity_at_screen_level.nc"
    )   #相对湿度场nc文件路径
    pressure_path = str(data_dir / "20181121T1200Z-PT0012H00M-pressure_at_mean_sea_level.nc")   #气压场nc文件路径
    output_path = str(data_dir / "cli_feels_like_temp_result.nc")   #输出nc文件路径
