...
para_example= {
    ...
    "station_file":r"D:/Work/optimize_tp_24h/resource/sta.m3",
    # "station_file":"",
    "defalut_value":0,
    "hdf_file_name":"verify_data.h5",
    "interp": meteva.base.interp_gs_nearest,
    "ob_data":{
        "dir_ob": r"D:/Work/optimize_tp_24h/resource/r24/sfc/YYMMDDHH.000",
        "hour": [8, 20, 12],
    ...
    "fo_data":{
        "optimize_TP_24H_250402": {
            "dir_fo": r"D:/Work/optimize_TP_24H_250402/resource/output/rain24/ecmwf/YYYYMMDDHH/YYYYMMDDHH.TTT.m3",
            "hour": [0, 12, 12],
            "dtime": [36, 252, 24],
            "read_method": meteva.base.io.read_stadata_from_micaps3,
            "read_para": {},
        ...
        "optimize_tp_24h": {
            "dir_fo": r"D:/Work/optimize_tp_24h/resource/output/rain24/ecmwf/YYYYMMDDHH/YYYYMMDDHH.TTT.m3",
            "hour": [0, 12, 12],
            "dtime": [36, 252, 24],
            "read_method": meteva.base.io.read_stadata_from_micaps3,
            "read_para": {},
