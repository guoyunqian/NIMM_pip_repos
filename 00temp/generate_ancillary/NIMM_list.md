...
| --- | --- | --- | --- | --- | --- |
| 辅助功能 | **generate_ancillary** | 海陆掩码二值化与地形带掩码生成 | 2026-07-25 | 郭云谦、王亭波 | `cli/anc_generate_landmask_ancillary.py`、`cli/dsc_generate_topography_bands_mask.py` |
...
| 测试 | `test/` | 单元测试与官方样例对照 |
| 整理日志 | `00log/generate_ancillary_整理_20260725.log` | 本次整理过程记录 |
...
| 3 | test_data | 样例约 1.5MB，中间目录未同步；可纳入 `NIMM_pip_testdata` 或正式入库前筛选 |
...
| 环境 | 结果 | 日期 |
| --- | --- | --- |
| 中间目录 `00temp/generate_ancillary/` | 26 passed, 3 skipped | 2026-07-25 |
| 原代码目录 `D:\workspace\improver\generate_ancillary` | 29 passed | 2026-07-25 |
